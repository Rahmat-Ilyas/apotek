 		...
 		<div class="topbar">
 			...
 			<div class="topbar-left">
 				<a href="index.php" class="logo">
 					<span>
 						<img src="/medik_rev/asset/images/reski.png" alt="" height="50">
 					</span>
 					<i>
 						<img src="/medik_rev/asset/images/reski.png" alt="" height="28">
 					</i>
 				</a>
 			</div>
 			...
 			<nav class="navbar-custom">
 				...
 				<ul class="list-unstyled topbar-right-menu float-right mb-0">
 					...
 					<li class="dropdown notification-list">
 						...
 						<img src="/medik_rev/asset/images/users/avatar-1.jpg" alt="user" class="rounded-circle"> <span class="ml-1"><i class="mdi mdi-chevron-down"></i> </span>
 					</a>
 					<div class="dropdown-menu dropdown-menu-right profile-dropdown ">
 						<!-- item-->
 						<div class="dropdown-item noti-title">
 							<h6 class="text-overflow m-0">Welcome !</h6>
 							<h6 class="text-overflow m-0">Staff</h6>
 						</div>
 				...
 				<ul class="metismenu" id="side-menu">
 					...
 					<li>
 						...
 						<ul class="nav-second-level" aria-expanded="false">
 							<li><a href="/medik_rev/staff/apotik/datalaporan.php"><i class="fa fa-fw fa-file-text"></i> Laporan</a></li>
 						</ul>				
 					</li>

 					<li>
 						<li><a href="/medik_rev/staff/apotik/kritik_saran.php"><i class="fa fa fa-envelope-open"></i>Kritik dan Saran</a></li>
 					</li>
