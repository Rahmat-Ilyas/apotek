...
else if (isset($_COOKIE['masuk_staff'])) {
  if ($_COOKIE['masuk_staff'] == 'true'){
...
else if (isset($_SESSION["login_staff"])) {
  ...
  if (mysqli_num_rows($cekusername) == 1) {
    ...
    if (password_verify($password, $row["password"])) {
      ...
      if ($row["id_akun"] == 1){
        ...
        if ($_POST["remember"]) {
          setcookie('masuk_staff','true',time()+3600);
        }
        $_SESSION["login_staff"] = true;
        header("Location: staff/");
        exit();
...
<head>
  ...
  <!-- App favicon -->
  <link rel="shortcut icon" href="asset/images/reski.png">
                ...
                <div class="account-logo-box">
                  <h2 class="text-uppercase text-center">
                    <a href="index.html" class="text-success">
                      <span><img src="asset/images/reski.png" alt="" height="70"></span>
                    </a>
                  </h2>
                  ...
                  <form class="form-horizontal" action="#" method="POST">
                    ...
                    <div class="form-group row m-b-20">
                      <div class="col-12">
                        ...
                        <input class="form-control" type="password" required="" id="password" placeholder="Masukkan Password" name="password">
                      </div>
                    </div>
